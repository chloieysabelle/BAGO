...
def create_login_box():
    ...
    if signup_box:
        ...
        print("Login box is already open.")
...
def admin_box_forget():
    create_admin_login_box.destroy()

# Function to create the signup wind
...
def hms_info():
    ...
    label = tk.Label(about_window, text="This is a Hospital Management System(HMS)")
    label.pack(pady=20)

    ok_button = tk.Button(about_window, text="OK", command=about_window.destroy)
    ok_button.pack(pady=20)

    back_home_button = tk.Button(about_window, text="Back to Home Page", command=lambda:(about_window.destroy(), display_homepage()))
...
def appointment_window(full_name, age, sex):
    ...
    home_button = tk.Button(appointment_window, command=show_main_window)
    home_button.pack()
...
def remove_login_box():
    create_login_box.destroy
...
background_image = Image.open("C:/Users/Chloie/Documents/project/home.png")
...
def display_homepage():
    ...
    admin_login_button = tk.Button(root, text="Admin Login", command=lambda:(create_admin_login_box, create_admin_login_box.destroy()))
    ...
    signup_button = tk.Button(root, text="Sign Up", command=lambda:(open_signup_window(), destroy_homepage()))
    signup_button.pack(side="right", anchor="ne", padx=10, pady=10)

    hms_info_button = tk.Button(root, text="About HMS", command=lambda:(destroy_homepage(), hms_info()))
